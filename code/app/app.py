...
while True:
    ...
    now = time.time()
    if detected_sign and detected_sign in LANGUAGE_MAP and (detected_sign != last_detected_sign or now - last_update_time > SIGN_HOLD_TIME):
    ...
    cv2.putText(img, f"Language: {current_lang_name} (1-4)", (20, 40), cv2.FONT_HERSHEY_SIMPLEX, .9, (255,255,255), 2)
    if display_text:
        cv2.putText(img, display_text, (20, 100), cv2.FONT_HERSHEY_SIMPLEX, 1.6, (0,255,255), 3)
